...
export function TestIndexCard({ indexData }) {
  ...
  const fetchExtraOptions = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/extra-options?currentPrice=${niftyLtp}`);
    ...
    >
      ...
      >
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="text-right">
            <div className="text-slate-400 text-xs">Nifty Future</div>
